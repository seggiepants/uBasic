...
90 IF UCASE$(LEFT$(A$,1))=="N" THEN GOTO 150
...
165 	IF I == 0 THEN GOTO 200
170 	FOR J = 0 TO I - 1
180 		IF A[I] == A[J] THEN GOTO 160
190 	NEXT J
200 NEXT I
...
230 PRINT "GUESS #";I;" "
240 INPUT A$
245 IF LEN(A$) <> 3 THEN GOTO 630
250 FOR Z = 0 TO 2 : A1[Z] = ASC(MID$(A$,Z + 1,1)) : NEXT Z
260 FOR J = 0 TO 2
REM 0 is 48 and 9 = 57 in ASCII
270 	IF A1[J] < 48 THEN GOTO 300
280 	IF A1[J] > 57 THEN GOTO 300
285 	B[J] = A1[J] - 48
290 NEXT J
295 GOTO 320
300 PRINT "WHAT?"
310 GOTO 230
REM CHECK FOR DUPLICATE DIGITS
320 IF B[0]==B[1] THEN GOTO 650
330 IF B[1]==B[2] THEN GOTO 650
340 IF B[2]==B[0] THEN GOTO 650
REM C = PICO COUNT, D = FERMI COUNT
350 C=0 : D=0
360 FOR J = 0 TO 1
370 	IF A[J] <> B[J + 1] THEN GOTO 390
380 	C=C + 1
390 	IF A[J + 1]<>B[J] THEN GOTO 410
400 	C=C + 1
410 NEXT J
420 IF A[0] <> B[2] THEN GOTO 440
430 C=C + 1
440 IF A[2]<>B[0] THEN GOTO 460
450 C=C + 1
460 FOR J=0 TO 2
470 	IF A[J]<>B[J] THEN GOTO 490
480 	D=D + 1
490 NEXT J
...
605 NEXT I
610 PRINT "OH WELL."
615 PRINT "THAT'S TWENTY GUESSES.  MY NUMBER WAS ";100 * A[0] + 10 * A[1] + A[2]
620 GOTO 700
...
720 IF UCASE$(LEFT$(A$, 1))=="Y" THEN GOTO 150
