...
210 PRINT "NUMBER";TAB(8);"PART";TAB(17);"NUMBER OF PART NEEDED"
220 PRINT "1";TAB(8);"BODY";TAB(17);"1"
230 PRINT "2";TAB(8);"NECK";TAB(17);"1"
240 PRINT "3";TAB(8);"HEAD";TAB(17);"1"
250 PRINT "4";TAB(8);"FEELERS";TAB(17);"2"
260 PRINT "5";TAB(8);"TAIL";TAB(17);"1"
270 PRINT "6";TAB(8);"LEGS";TAB(17);"6"
280 PRINT ""
290 PRINT ""
300 IF Y>0 THEN GOTO 2480
310 Z=INT(6*RND(1)+1)
320 C=1
330 PRINT "YOU ROLLED A ";Z
340 IF Z == 1 THEN GOTO 350
IF Z == 2 THEN GOTO 430
IF Z == 3 THEN GOTO 540
IF Z == 4 THEN GOTO 650
IF Z == 5 THEN GOTO 760
IF Z == 6 THEN GOTO 870
350 PRINT "1=BODY"
360 IF B==1 THEN GOTO 410
...
990 IF X == 1 THEN GOTO 1000
IF X == 2 THEN GOTO 1080
IF X == 3 THEN GOTO 1190
IF X == 4 THEN GOTO 1300
IF X == 5 THEN GOTO 1410
IF X == 6 THEN GOTO 1520
1000 PRINT "1=BODY"
...
1580 GOTO 1630
1590 PRINT SPACE(5); "I HAVE 6 FEET."
1600 GOTO 1630
1610 PRINT "I DO NOT HAVE A BODY."
1620 GOTO 1630
1630 IF A==2 AND T==1 AND L==6 THEN GOTO 1650
1640 GOTO 1670
1650 PRINT "YOUR BUG IS FINISHED."
1660 Y=Y+1
1670 IF S==2 AND P==1 AND V==6 THEN GOTO 1690
1680 GOTO 1710
1690 PRINT "MY BUG IS FINISHED."
1700 Y=Y+2
1710 IF C==1 THEN GOTO 300
1720 PRINT "DO YOU WANT THE PICTURES? ";
1730 INPUT Z$
1740 IF Z$=="NO" THEN GOTO 300
1750 PRINT "*****YOUR BUG*****"
1760 PRINT
1770 PRINT
